					...
					<h4 class="text-center">Registration Page</h4>
						<form action="register" method="post">
							<div class="mb-3">
								...
								<div id="emailHelp" required="required" name="fname" class="form-text">We'll never share
							...
							<div class="mb-3">
								...
								<div id="emailHelp" required="required" name="email" class="form-text">We'll never share
									your email with anyone else.</div>
							</div>
							<div class="mb-3">
								<label for="phone number" class="form-label">Phone
									...
									id="exampleInputEmail1" aria-describedby="emailHelp">
								<div id="emailHelp" required="required" name="phno" class="form-text">We'll never share
									your email with anyone else.</div>
							</div>
							<div class="mb-3">
							...
							<div class="mb-3 form-check">
								<input type="checkbox" required="required" name="check" class="form-check-input"
